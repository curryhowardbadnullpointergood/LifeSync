...
$: isStarredPage = $page.url.pathname === '/starred';
...
<header>
  <nav class="navbar">
    <div class="leftSide">
      ...
      <button aria-label="Menu" on:click={toggle}> 
    ...
    <div class="rightSide">
      ...
      <div class="task">
        ...
        <button aria-label="tasks" class:active={isTasksPage || isStarredPage}>  
